...
import com.example.hebam.notekeeper.NoteKeeperDatabaseContract.CourseInfoEntry;
...
public class NoteActivity extends AppCompatActivity {
    ...
    /**
    * This will be used to determine the key names that will get passed with an intent
     * since the intent may come from different resources use the second declaration
     * to make it unique
    * */
//    Method #1
//    public static final String NOTE_INFO = "NOTE_INFO";
//    public static final String NOTE_INFO = "com.example.hebam.notekeeper.NOTE_INFO";
//    Method #2
    public static final String NOTE_ID = "com.example.hebam.notekeeper.NOTE_ID";
...
//        mSpinnerCourses.setAdapter(adapterCourses);
        ...
        //Method#2: to work with data from the db
        ...
        if(savedInstanceState == null) {
            //initial creation of the activity
